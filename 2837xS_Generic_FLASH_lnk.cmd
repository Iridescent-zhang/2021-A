...
PAGE 0 :  /* Program Memory */
   ...
   RAMLS01234          	: origin = 0x008000, length = 0x002000
...
//   RAMM1_RSVD      : origin = 0x0007F8, length = 0x000008     /* Reserve and do not use for code as per the errata advisory "Memory: Prefetching Beyond Valid Memory" */
   ...
   RAMGS891011      : origin = 0x014000, length = 0x003FF8
...
SECTIONS
{
   ...
   .cinit              : > FLASHEF      PAGE = 0, ALIGN(8)
   .pinit              : > FLASHAB,     PAGE = 0, ALIGN(8)
   .text               : >> FLASHAB | FLASHCD | FLASHEF      PAGE = 0, ALIGN(8)
   codestart           : > BEGIN       PAGE = 0, ALIGN(8)

   /* Allocate uninitalized data sections: */
   .stack              : > RAMM1        PAGE = 1
#if defined(__TI_EABI__)
   .init_array         : > FLASHAB,       PAGE = 0,       ALIGN(8)
   .bss                : > RAMLS5,       PAGE = 1
   ...
   ramgs1           : > RAMGS1,    PAGE = 1
	...
	RFFTdata2		: > RAMGS45,	PAGE = 1
	RFFTdata3		: > RAMGS67,	PAGE = 1
	RFFTdata4		: > RAMLS01234,	PAGE = 0
	RFFTdata5		: > RAMGS23,	PAGE = 1
	adcAResultsdata : > RAMGS891011,	PAGE = 1
}
